            ...
            timelineData: [
                {
                    ...
                    title: "Inicio",
                    desc:
                        "Encontrarás el acceso a la pantalla de Inicio,la seccion para agregar ART nuevos y listar los ART registrados"
                },
                {
                    color: "success",
                    icon: "LayoutIcon",
                    title: "Nuevo ART",
                    desc:
                        "En esta seccion, podras agregar nuevos ART o Asociar ART a uno ya creado"
                },
                {
                    color: "primary",
                    icon: "LayoutIcon",
                    title: "Listado ART",
                    desc:
                        "En esta seccion, podras ver los ART registrados, podrias modificar los ART creados si es necesario o ver su seguimiento de pagos"
                }
            ]
        };
    }
